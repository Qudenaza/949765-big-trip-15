...
export const createTripPointTemplate = (trip) => {
  ...
  const tripPointSchedulteTemplate = createTripPointScheduleTemplate(trip.date_from, trip.date_to);

  const favoriteClassName = trip.is_favorite ? 'event__favorite-btn event__favorite-btn--active' : 'event__favorite-btn';

  return `<li class="trip-events__item">
            <div class="event">
              <time class="event__date" datetime="${formatDate(trip.date_from, 'YYYY-MM-DD')}">${formatDate(trip.date_from, 'MMM DD')}</time>
              ...
              <p class="event__price">
                &euro;&nbsp;<span class="event__price-value">${trip.base_price}</span>
              </p>
